...
//	// Photo insert
//	@PostMapping
//	public ResponseEntity<Void> insertPhoto(@RequestParam String photoTitle, @RequestParam String photoWriter, @RequestParam(required = false) MultipartFile[] files, @RequestParam String photoContents) throws Exception{
...
//	public ResponseEntity<Void> updatePhoto(@PathVariable Long photoId, @RequestParam String photoTitle, @RequestParam(required = false) MultipartFile[] files, @RequestParam String photoContents) throws Exception{
//	
